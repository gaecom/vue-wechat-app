<template>
    ...
    <div class="add-friend">
        ...
        <p style="padding-top:8px;text-align: center;">
            <span>我的微信号:</span>
            <span>10086</span>
            <router-link to="/self/profile/myqrcode">&nbsp;<img src="../../assets/images/contact_add-friend-my-qr.png" style="vertical-align: middle;;width:24px" class="_align-middle"></router-link>
        </p>
